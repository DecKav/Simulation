...
Sam changes 15/5:
    added Task duration
    added getName method for Node to improve readability
    Added order tracker class
    I have a feeling we should change Node such that we add tasks, not cars, to each node.
"""
